      ...
      if (incidentSearch.trim()) {
        ...
        filtered = filtered.filter(
          (incident: any) =>
            ...
            incident.profiles?.first_name?.toLowerCase().includes(searchTerm) ||
            incident.profiles?.last_name?.toLowerCase().includes(searchTerm)
        );
      }
      ...
      if (documentSearch.trim()) {
        ...
        filtered = filtered.filter(
          (doc: any) =>
            ...
            doc.profiles?.first_name?.toLowerCase().includes(searchTerm) ||
            doc.profiles?.last_name?.toLowerCase().includes(searchTerm)
        );
      }
                      ...
                      .map((incident) => (
                        ...
                        >
                          <TableCell className="font-medium text-purple-900">
                           ...
                           <TableCell>
                             {incident.profiles?.first_name}{" "}
                             {incident.profiles?.last_name}
                           </TableCell>
          ...
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto border-purple-200">
            <DialogHeader>
              ...
              <DialogDescription className="text-purple-700">
                ...
                {selectedVerification?.first_name}{" "}
